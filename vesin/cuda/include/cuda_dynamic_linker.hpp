#ifndef CUDA_DYNAMIC_LINKER_HEADER_HPP
#define CUDA_DYNAMIC_LINKER_HEADER_HPP
...
#include <nvrtc.h> // NVRTC (CUDA Runtime Compilation API)

// Error-checking macro for NVRTC calls
...
// Error-checking macro for CUDA Driver API calls
...
// Template function to load a symbol from a dynamic library
...
// Class to dynamically load and use functions from the CUDA Runtime library
// (libcudart.so)
class CUDART {
public:
  ...
  // Define function pointer types for all required CUDA Runtime API functions
  ...
  using cudaMemcpy_t = cudaError_t (*)(void *, const void *, size_t,
                                       cudaMemcpyKind);
  ...
  using cudaPointerGetAttributes_t = cudaError_t (*)(cudaPointerAttributes *,
                                                     const void *);
  ...
  // Constructor loads the shared library and resolves all symbols
  CUDART() {
#ifdef __linux__
...
#error "Platform not supported"
    ...
    if (cudartHandle) {
      ...
      cudaGetDeviceCount =
          load<cudaGetDeviceCount_t>(cudartHandle, "cudaGetDeviceCount");
      ...
      cudaGetErrorName =
          load<cudaGetErrorName_t>(cudartHandle, "cudaGetErrorName");
      cudaGetErrorString =
          load<cudaGetErrorString_t>(cudartHandle, "cudaGetErrorString");
      cudaDeviceSynchronize =
          load<cudaDeviceSynchronize_t>(cudartHandle, "cudaDeviceSynchronize");
      cudaPointerGetAttributes = load<cudaPointerGetAttributes_t>(
          cudartHandle, "cudaPointerGetAttributes");
...
#error "Platform not supported"
  ...
  void *cudartHandle = nullptr; // Handle to libcudart.so
};

// Class for dynamically loading and using CUDA Driver API functions from
// libcuda.so
class CUDADriver {
public:
  ...
  // Function pointer type definitions for CUDA Driver API
  ...
  using cuModuleGetFunction_t = CUresult (*)(CUfunction *, CUmodule,
                                             const char *);
  using cuFuncSetAttribute_t = CUresult (*)(CUfunction, CUfunction_attribute,
                                            int);
  using cuFuncGetAttribute_t = CUresult (*)(int *, CUfunction_attribute,
                                            CUfunction);
  using cuCtxGetDevice_t = CUresult (*)(CUdevice *);
  using cuDeviceGetAttribute_t = CUresult (*)(int *, CUdevice_attribute,
                                              CUdevice);
  ...
  using cuPointerGetAttribute_t = CUresult (*)(void *, CUpointer_attribute,
                                               CUdeviceptr);
...
#endif
    if (cudaHandle) {
      // Load all required Driver API symbols
      cuInit = load<cuInit_t>(cudaHandle, "cuInit");
      cuDeviceGetCount =
          load<cuDeviceGetCount_t>(cudaHandle, "cuDeviceGetCount");
      cuCtxCreate = load<cuCtxCreate_t>(cudaHandle, "cuCtxCreate");
      cuCtxDestroy = load<cuCtxDestroy_t>(cudaHandle, "cuCtxDestroy");
      cuDevicePrimaryCtxRetain = load<cuDevicePrimaryCtxRetain_t>(
          cudaHandle, "cuDevicePrimaryCtxRetain");
      cuDevicePrimaryCtxRelease = load<cuDevicePrimaryCtxRelease_t>(
          cudaHandle, "cuDevicePrimaryCtxRelease");
      ...
      cuModuleLoadDataEx =
          load<cuModuleLoadDataEx_t>(cudaHandle, "cuModuleLoadDataEx");
      cuModuleGetFunction =
          load<cuModuleGetFunction_t>(cudaHandle, "cuModuleGetFunction");
      cuFuncSetAttribute =
          load<cuFuncSetAttribute_t>(cudaHandle, "cuFuncSetAttribute");
      cuFuncGetAttribute =
          load<cuFuncGetAttribute_t>(cudaHandle, "cuFuncGetAttribute");
      cuCtxGetDevice = load<cuCtxGetDevice_t>(cudaHandle, "cuCtxGetDevice");
      cuDeviceGetAttribute =
          load<cuDeviceGetAttribute_t>(cudaHandle, "cuDeviceGetAttribute");
      cuDeviceGetName = load<cuDeviceGetName_t>(cudaHandle, "cuDeviceGetName");
      cuDeviceTotalMem =
          load<cuDeviceTotalMem_t>(cudaHandle, "cuDeviceTotalMem");
      ...
      cuCtxSynchronize =
          load<cuCtxSynchronize_t>(cudaHandle, "cuCtxSynchronize");
      cuGetErrorName = load<cuGetErrorName_t>(cudaHandle, "cuGetErrorName");
      cuCtxPushCurrent =
          load<cuCtxPushCurrent_t>(cudaHandle, "cuCtxPushCurrent");
...
#error "Platform not supported"
  ...
  void *cudaHandle = nullptr; // Handle to libcuda.so
};

// Class to dynamically load and access NVRTC functions (for runtime CUDA
// compilation)
class NVRTC {
public:
  ...
  // Function pointer types for NVRTC API
  using nvrtcCreateProgram_t = nvrtcResult (*)(nvrtcProgram *, const char *,
                                               const char *, int,
                                               const char *[], const char *[]);
  using nvrtcCompileProgram_t = nvrtcResult (*)(nvrtcProgram, int,
                                                const char *[]);
  ...
  using nvrtcAddNameExpression_t = nvrtcResult (*)(nvrtcProgram,
                                                   const char *const);
  using nvrtcGetLoweredName_t = nvrtcResult (*)(nvrtcProgram, const char *,
                                                const char **);
...
#endif
    if (nvrtcHandle) {
      // Load all required NVRTC functions
      nvrtcCreateProgram =
          load<nvrtcCreateProgram_t>(nvrtcHandle, "nvrtcCreateProgram");
      nvrtcCompileProgram =
          load<nvrtcCompileProgram_t>(nvrtcHandle, "nvrtcCompileProgram");
      nvrtcGetPTX = load<nvrtcGetPTX_t>(nvrtcHandle, "nvrtcGetPTX");
      nvrtcGetPTXSize = load<nvrtcGetPTXSize_t>(nvrtcHandle, "nvrtcGetPTXSize");
      nvrtcGetProgramLog =
          load<nvrtcGetProgramLog_t>(nvrtcHandle, "nvrtcGetProgramLog");
      nvrtcGetProgramLogSize =
          load<nvrtcGetProgramLogSize_t>(nvrtcHandle, "nvrtcGetProgramLogSize");
      nvrtcGetLoweredName =
          load<nvrtcGetLoweredName_t>(nvrtcHandle, "nvrtcGetLoweredName");
      nvrtcAddNameExpression =
          load<nvrtcAddNameExpression_t>(nvrtcHandle, "nvrtcAddNameExpression");
      nvrtcDestroyProgram =
          load<nvrtcDestroyProgram_t>(nvrtcHandle, "nvrtcDestroyProgram");
      nvrtcGetErrorString =
          load<nvrtcGetErrorString_t>(nvrtcHandle, "nvrtcGetErrorString");
    }
  }
...
#error "Platform not supported"
  ...
  void *nvrtcHandle = nullptr; // Handle to libnvrtc.so
};

// Macros to access singletons
